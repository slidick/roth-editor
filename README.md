...
### DBase Editor
Also available is support for editing some of the additional game files. Go to *Main -> Manage DBase Files* to get started. You should start by duplicating the original files and giving it a name. The DBase pack set as *Active* will be used when testing maps with the R key.
...
See the [DBase Section for more details](#dbase-editor-features)

![Screenshot ManageDBase](doc/screen-manage-dbase.png)

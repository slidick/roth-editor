...
func map_pack(p_type: Type, p_map_pack: Dictionary = {}) -> Variant:
	...
	%DAS2Option.clear()
	for das2_info: Dictionary in Roth.das2_packs:
...
func _changed() -> void:
	var error: String = Roth.check_map_pack_name(%NameEdit.text)
